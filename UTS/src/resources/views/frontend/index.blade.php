...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="index.html">salutika<span>.</span></a></h1>
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1>Healty Food<span>.</span></h1>
          <h2>Salad and Juice</h2>
        </div>
      </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
            <h3>Visi:</h3>
            <p class="fst-italic">
            Menjadi restoran terdepan yang menyediakan pilihan salad dan jus buah segar, sehat, dan terjangkau untuk gaya hidup masyarakat modern.
            </p>
            <h3>Misi:</h3>
            <ul>
              <li><i class="ri-check-double-line"></i> Menyediakan menu salad dan jus buah yang bervariasi dan menggunakan bahan-bahan segar dan berkualitas tinggi.</li>
              <li><i class="ri-check-double-line"></i> Menjaga kebersihan dan keamanan dalam proses pengolahan makanan dan minuman.</li>
              <li><i class="ri-check-double-line"></i> Memberikan pelayanan yang ramah dan membantu kepada semua pelanggan.</li>
              <li><i class="ri-check-double-line"></i> Mempromosikan gaya hidup sehat melalui menu-menu yang ditawarkan.</li>
              <li><i class="ri-check-double-line"></i> Menjaga keberlanjutan lingkungan dengan menggunakan bahan-bahan yang bersumber dari petani lokal dan mengurangi penggunaan kemasan plastik.</li>
            </ul>
            <h3>Deskripsi:</h3>
            <p class="fst-italic">
            Restoran Salutika: Salad dan Jus Segar untuk Gaya Hidup Sehat

Salutika adalah restoran yang berfokus menyediakan pilihan salad dan jus buah yang segar, sehat, dan lezat. Kami bercita-cita menjadi pelopor gaya hidup sehat dengan menawarkan menu bernutrisi tinggi namun tetap terjangkau.
            </p>
          </div>
        </div>
